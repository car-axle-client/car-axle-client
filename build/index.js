  ...
  var t = {
      ...
      716: (t, e, n) => {
        ...
        var o = n(379),
          ...
          f = n(537),
          _ = {};
        (_.styleTagTransform = p()),
          (_.setAttributes = u()),
          (_.insert = c().bind(null, "head")),
          (_.domAPI = s()),
          (_.insertStyleElement = m()),
          i()(f.Z, _);
        const g = f.Z && f.Z.locals ? f.Z.locals : void 0;
      },
      406: (t, e, n) => {
        n.r(e), n.d(e, { default: () => g });
        var o = n(379),
      ...
      379: (t) => {
        ...
        t.exports = function (t, i) {
          ...
          return function (t) {
            ...
            for (var c = o(t, i), l = 0; l < a.length; l++) {
              var u = n(a[l]);
      ...
      228: function (t, e, n) {
        ...
        n(36),
          (e.UIManager = class {
            constructor() {
              (this.sections = []),
                (this.container = (0, l.createElement)("div", document.body, {
                  id: "cac__CONTAINER",
                })),
                (this.gui = (0, l.createElement)("div", this.container, {
                  id: "cac__GUI",
                })),
                (this.sidebar = (0, l.createElement)("div", this.gui, {
                  id: "cac__SIDEBAR",
                })),
                (this.mainContent = (0, l.createElement)("div", this.gui, {
                  id: "cac__MAINCONTENT",
                })),
                (this._sectionBackground = (0, l.createElement)(
                  "div",
                  this.sidebar,
                  { id: "cac__section__BACKGROUND" },
                )),
                (this.tabbar = (0, l.createElement)("div", this.mainContent, {
                  id: "cac__TABBAR",
                })),
                (0, l.createElement)("div", this.sidebar, {
                  id: "cac__LOGO",
            ...
            _enableSection(t) {
              (this.enabledSection = t),
                (t.enabled = !0),
                (t.sectionContent.style.display = "block"),
                (t.sectionContent.style.pointerEvents = "auto"),
                this._sectionBackground.animate(
                  [{ top: `${t.navButton.offsetTop}px` }],
                  { duration: 1e3, fill: "forwards", easing: "ease" },
                ),
                t.sectionContent.animate(
                  [
            ...
            _disableSection(t) {
              (t.enabled = !1),
                ...
                setTimeout(() => {
                  (t.sectionContent.style.display = "none"),
                    (t.sectionContent.style.pointerEvents = "none;");
                }, 490);
            }
            _handleSectionMouseDown(t) {
              t.enabled ||
                (this.enabledSection &&
                  this._disableSection(this.enabledSection),
                this._enableSection(t));
            }
            newSection(t, e, n, o, a = !1) {
              let s = new i.Section(
                t,
                e,
                n,
              ...
              return (
                (s.navButton.onmousedown = () =>
                  this._handleSectionMouseDown(s)),
                a && this._enableSection(s),
            ...
            getSectionFromID(t) {
              return this.sections.find((e) => e.id === t);
            }
          });
      },
      407: (t, e, n) => {
        ...
        n(716),
          (function (t) {
            (t.checkbox = "checkbox"), (t.text = "text");
          })(i || (i = {})),
          (e.default = class {
            constructor(t, e, n, o, i, a = !1, s) {
              (this.enabled = !1),
                (this.menuValues = []),
                (this.parent = t),
                (this.title = e),
                (this.onClickFunction = i),
                (this.always = n),
                (this.reset = o),
                (this.menuOptions = s),
                s.length > 0 &&
            ...
            _toggle() {
              (this.enabled = !this.enabled),
                ...
                this.enabled
                  ? this.onClickFunction(!0, this.menuValues)
                  : this.onClickFunction(!1, this.menuValues);
            }
            _getMenuValues() {
              this.menuValues = [];
              for (let t of this.menuContainer.querySelectorAll(
                ".cac__button__menu-container__option-container",
              )) {
                ...
                e
                  ? this.menuValues.push(e.checked)
                  : n && this.menuValues.push(n.value);
              }
            }
            _updateFunctionOptions() {
              this._getMenuValues(), this._toggle(), this._toggle();
            }
            _addMenuOption(t) {
              const e = (0, o.createElement)("div", this.menuContainer, {
                className: "cac__button__menu-container__option-container",
              });
              switch (
                ((0, o.createElement)("p", e, {
                  className:
                    "cac__button__menu-container__option-container__title",
                  innerHTML: t.title,
                }),
                ...
                case i.checkbox:
                  const n = (0, o.createElement)("input", e, {
                    type: "checkbox",
                    className:
                      "cac__button__menu-container__option-container__checkbox",
                  });
                  ...
                  break;
                case i.text:
                  const a = (0, o.createElement)("input", e, {
                    type: "text",
                    className:
                      "cac__button__menu-container__option-container__text",
                  });
            ...
            _toggleMenu(t) {
              ...
              t.preventDefault(),
                ...
                null === (e = this.button.querySelector("svg")) ||
                  void 0 === e ||
                  e.classList.toggle("cac__button__menuicon--enabled");
            }
            _handleMouseDown(t) {
              var e;
              2 === t.button &&
                (null === (e = this.menuOptions) || void 0 === e
                  ? void 0
                  : e.length) > 0 &&
                this._toggleMenu(t),
                0 !== t.button ||
            ...
            render() {
              if (
                ((this.button = (0, o.createElement)("button", this.parent, {
                ...
                this.button.addEventListener("contextmenu", (t) =>
                  t.preventDefault(),
                ),
                this.menuOptions.length > 0)
              ) {
                this.menuContainer = (0, o.createElement)("div", this.parent, {
                  className: "cac__button__menu-container",
                });
                for (let t of this.menuOptions) this._addMenuOption(t);
              }
            }
            get values() {
      ...
      389: (t, e, n) => {
        ...
        n(406),
          (e.default = class {
            ...
            render() {
              (this.iconElement = (0, o.createElement)("button", this.parent, {
                className: "cac__tabbar__button",
                innerHTML: this.icon,
              })),
                (this.iconElement.onclick = this.action),
                (this.hoverName = (0, o.createElement)("p", this.iconElement, {
        ...
        n(406),
          (e.default = class {
            ...
            action(t) {
              ...
              let e = [];
              for (let n of t.sections) {
                let t = n.getAllButtonValues();
                console.log("%c" + n.id, "font-size:1.25vw;"),
                  console.table(t),
                  e.push({ sectionID: n.id, buttonValues: t });
              }
              localStorage.setItem("car-axle-client", JSON.stringify(e));
            }
            render() {
              (this.iconElement = (0, o.createElement)("button", this.parent, {
                className: "cac__tabbar__button",
      ...
      669: (t, e, n) => {
        ...
        n(406),
          (e.default = class {
            ...
            action() {
              var t;
              null === (t = document.getElementById("cac__CONTAINER")) ||
                void 0 === t ||
                t.remove();
            }
            render() {
      ...
      67: (t, e, n) => {
        Object.defineProperty(e, "__esModule", { value: !0 }), n(832);
        const o = n(539);
        e.default = class {
          constructor(t, e, n, i) {
            (this.parent = t),
              ...
              this.render(),
              i &&
                ((0, o.createElement)("button", this.notification, {
                  className: "cac__notification__button",
                  innerHTML: i.text,
                }).onclick = (t) => i.fn());
          }
          render() {
            (this.notification = (0, o.createElement)("div", this.parent, {
              className: "cac__notification",
            })),
              (0, o.createElement)("h1", this.notification, {
                className: "cac__notification__header",
                innerHTML: this.title,
              }),
              (0, o.createElement)("p", this.notification, {
              ...
              ((0, o.createElement)("button", this.notification, {
                className: "cac__notification__button",
                innerHTML: "Dismiss",
              }).onclick = (t) => this.notification.remove());
          }
          display(t = 500) {}
        };
      },
          ...
          (e.Section = class {
            constructor(t, e, n, o, i, a, s = !1) {
              (this.buttons = []),
                ...
                (this._icon = o),
                (this.enabled = s),
                this._createSectionElements(a),
                "client" === this.id
                  ? ((this.navButton.style.position = "absolute"),
                    (this.navButton.style.bottom = "9.5vh"))
                  : "credit" === this.id &&
                    ((this.navButton.style.position = "absolute"),
                    (this.navButton.style.bottom = "20px"));
            }
            _createSectionElements(t) {
              (this.navButton = (0, i.createElement)("div", this._container, {
                className: "cac__section",
                innerHTML: this._icon + this._displayName,
              })),
                (this.sectionContent = (0, i.createElement)("div", t, {
                  className: "cac__section__content",
                  id: `cac__content__${this.id}`,
                })),
                (0, i.createElement)("h1", this.sectionContent, {
                  innerHTML: this._displayName,
                  className: "cac__section__title",
                }),
                (0, i.createElement)("p", this.sectionContent, {
                  innerHTML: this._description,
                  className: "cac__section__description",
                });
            }
            addButton(t, e, n, o, i = !1, s) {
              this.buttons.push(
                new a.default(this.sectionContent, t, e, n, o, i, s),
              );
            }
            getAllButtonValues() {
              return this.buttons.map((t) => [t.enabled]);
            }
            setAllButtonValuesFromArray(t) {
              for (const [e, n] of t.entries())
                this.buttons[e].values = { enabled: n[0] };
            }
          });
      },
      333: (t, e) => {
      ...
      761: function (t, e, n) {
        (this && this.__createBinding) || Object.create,
          (this && this.__setModuleDefault) || Object.create;
        function o(t) {
          document.getElementById("cac__games__iframe").setAttribute("src", t);
        }
        this && this.__importStar,
          Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.functions = void 0),
          (e.functions = {
            NoForceReload: function (t, e) {
            ...
            game2048: function (t, e) {
              t && o("https://penguinify-web-dev.github.io/2048/");
            },
            gameretrobowl: function (t, e) {
              t &&
                o("https://penguinify-web-dev.github.io/retro-bowl/retro.html");
            },
            mouseTrail: function (t, e) {
              if (t) {
                const t = document.createElement("div");
                (t.id = "cac__mouseTrail"),
                  (t.style.position = "fixed"),
                  (t.style.width = "30px"),
                  (t.style.height = "30px"),
                  (t.style.borderRadius = "50%"),
                  (t.style.backgroundColor = "rgba(255, 255, 255, 0.5)"),
                  (t.style.zIndex = "9999999999999999999999"),
                  (t.style.transition = "border 0.5s ease"),
                ...
                const t = document.getElementById("cac__mouseTrail");
                t && t.remove();
              }
            },
            adremover: function (t, e) {
              t &&
                (function (t) {
                  var e = {
                    elem(e) {
                    ...
                    list(t) {
                      Array.from(t).forEach((t) => e.elem(t));
                    },
                    cls(t) {
                      e.list(document.getElementsByClassName(t));
                    },
                    selector(t) {
                      e.list(document.querySelectorAll(t));
                    },
                    func({ func: t, selector: n = null }) {
                      let o =
                        null == n
                          ? document.getElementsByClassName("*")
                          : document.querySelectorAll(n);
                      for (let n of o) t(n) && e.elem(n);
                    },
                  };
                  for (let [n, o] of Object.entries(t))
                    if ("ignore" != n) for (let t of o) e[n](t);
                })({
                  cls: [
                    "adsbygoogle",
                    "mod_ad_container",
                  ...
                  func: [
                    {
                      ...
                      func(t) {
                        for (let e of [t.id, ...t.classList])
                          if (
                            /(?<!lo)ad(vertisement)?(content)?(engine|ngin)?(container)?($|[-_,\s])/.test(
                              e,
                            )
                          )
                            return !0;
                  ...
                  ignore: {
                    ...
                    func: [
                      (t) => {
                        ...
                        for (let n of e) if (t.contains(n)) return !0;
                      },
                    ],
                  },
                });
            },
            editPageText: function (t, e) {
              document.body.contentEditable = t ? "true" : "false";
            },
            none: function (t, e) {},
            betterforceselect: function (t, e) {
            ...
            bloons1: function (t, e) {
              t && o("https://penguinify-web-dev.github.io/bloons");
            },
            bloons2: function (t, e) {
              t && o("https://penguinify-web-dev.github.io/bloons1");
            },
            agario: function (t, e) {
              t &&
                o(
                  "https://penguinify-web-dev.github.io/agario-minigame/dots.html",
                );
            },
            motoxm3winter: function (t, e) {
              t &&
                o(
                  "https://penguinify-web-dev.github.io/wintermotox3m/index.html",
                );
            },
            slope: function (t, e) {
              t && o("https://penguinify-web-dev.github.io/slope/index.html");
            },
            rom: function (t, e) {
              t &&
                o(
                  "https://penguinify-web-dev.github.io/temptations/index.html",
                );
            },
            yohoho: function (t, e) {
              t && o("https://penguinify-web-dev.github.io/yohoho/index.html");
            },
            uhoh: function (t, e) {
              !(function t(e) {
                var n = e.childNodes;
            ...
            bbs: function (t, e) {
              t &&
                o(
                  "https://penguinify-web-dev.github.io/basketball-stars/index.html",
                );
            },
            suggest: function (t, e) {
              t &&
                window.open(
                  "https://github.com/car-axle-client/car-axle-client/issues/new?assignees=&labels=enhancement&projects=&template=new_feature.md&title=Feature",
                );
            },
            minecraft: function (t, e) {
              t &&
                o(
                  "https://penguinify-web-dev.github.io/Offline_Download_Version.html",
                );
            },
          });
      },
              ...
              1 >= Number(e.version)
                ...
                : ((n = t),
                  ...
                  new i.default(
                    ...
                    `You can update from <strong>v1 (i: 0) -> v${o}</strong><br> Updating can fix issues you may currently be having and will add new features. They can also cause issues. Be careful!`,
                    {
                      text: "Install",
                      fn: () =>
                        window.open(
      ...
      859: (t) => {
        t.exports = JSON.parse(
          '[{"section":"exploit","display":"NoForceReload","function":"NoForceReload","always":false,"reset":false},{"section":"exploit","display":"<i style=\'font-family:\\"Comic Sans MS\\"\'>ad remover -</i>","function":"adremover"},{"section":"exploit","display":"Better Force Select","function":"betterforceselect","always":true},{"section":"game","display":"rom loader","reset":true,"function":"rom"},{"section":"game","display":"yohoho","reset":true,"function":"yohoho"},{"section":"game","display":"2048","reset":true,"function":"game2048"},{"section":"game","display":"Minecraft","reset":true,"function":"minecraft"},{"section":"game","display":"Retro Bowl","reset":true,"function":"gameretrobowl"},{"section":"game","display":"Bloons TD 1","reset":true,"function":"bloons1"},{"section":"game","display":"Bloons TD 2","reset":true,"function":"bloons2"},{"section":"game","display":"Agar IO (i think)","reset":true,"function":"agario"},{"section":"game","display":"Moto XM3 Winter","reset":true,"function":"motoxm3winter"},{"section":"game","display":"slope","reset":true,"function":"slope"},{"section":"game","display":"Basketball Stars","reset":true,"function":"bbs"},{"section":"client","display":"Suggest A Feature","reset":true,"function":"suggest"},{"section":"fun","display":"Mouse Trail","options":[{"title":"Trail?","type":"checkbox","default":true}],"function":"mouseTrail"},{"section":"fun","display":"Edit Page Text","function":"editPageText"},{"section":"fun","display":"dont use this","function":"uhoh","always":true},{"section":"client","display":"v2 (i:0)","always":false,"reset":true},{"section":"client","display":"Backslash to hide and unhide!","always":false,"reset":true},{"section":"client","display":"Check for updates","reset":true,"function":"checkupdate"},{"section":"credit","display":"yexex for the games (every game is skidded from him)","reset":true},{"section":"credit","display":"EmulatorJS Community","reset":true},{"section":"credit","display":"@penguinify on discord","reset":true}]',
        );
      },
    },
    e = {};
    ...
    (() => {
      ...
      !(function () {
        const s = new t.UIManager(),
          ...
          c = (0, i.createElement)("iframe", r.sectionContent, {
            id: "cac__games__iframe",
          });
        c.setAttribute("src", "https://penguinify-web-dev.github.io/yourgay"),
          s.newSection(
            "exploit",
            "Exploits",
          ...
          (function (t) {
            const i = n(859);
            for (let n of i) {
              const i = t.getSectionFromID(n.section);
              if (null == i) {
                o.DEBUG && console.log(`[UI] Section ${n.section} not found!`);
                continue;
              }
              const a = e.functions[n.function] || e.functions.none;
              (n.always = n.always || !1),
                (n.reset = n.reset || !1),
                (n.options = n.options || {}),
                i.addButton(n.display, n.always, n.reset, a, !0, n.options),
                o.DEBUG &&
                  console.log(
                    `[UI] Added module ${n.display} to section ${n.section}`,
                  );
            }
            localStorage.getItem("car-axle-client") &&
              (function (t) {
                JSON.parse(localStorage.getItem("car-axle-client")).forEach(
                  function (e) {
                    var n;
                    null === (n = t.getSectionFromID(e.sectionID)) ||
                      void 0 === n ||
                      n.setAllButtonValuesFromArray(e.buttonValues);
                  },
                );
              })(t);
          })(s),
          document.addEventListener("keydown", (t) => {
            "\\" === t.key && s.toggleUI(),
              "F" === t.key && t.shiftKey && c.requestFullscreen();
          }),
          (0, a.getUpdate)(s.container);
      })();
    })();
})();
