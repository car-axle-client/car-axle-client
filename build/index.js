    ...
    var t = {
            ...
            228: function (t, e, n) {
                ...
                n(36),
                    (e.UIManager = class {
                        constructor() {
                            ;(this.sections = []),
                                (this.container = (0, l.createElement)(
                                    'div',
                                    document.body,
                                    {
                                        id: 'cac__CONTAINER',
                                ...
                                (this.sidebar = (0, l.createElement)(
                                    'div',
                                    this.gui,
                                    {
                                        id: 'cac__SIDEBAR',
                                ...
                                (this.mainContent = (0, l.createElement)(
                                    'div',
                                    this.gui,
                                    {
                                        id: 'cac__MAINCONTENT',
                            ...
                            ;(t.enabled = !1),
                                ...
                                setTimeout(() => {
                                    ;(t.sectionContent.style.display = 'none'),
                                        (t.sectionContent.style.pointerEvents =
                                            'none;')
                                }, 490)
                        }
                    ...
                    (e.default = class {
                            ...
                            switch (
                                ...
                                case i.checkbox:
                                    ...
                                    ;(n.checked = t.default),
                                        n.addEventListener(
                                            'change',
                                            this._updateFunctionOptions.bind(
                                                this
                                            )
                                        )
                                    break
                        ...
                        _toggleMenu(t) {
                            ...
                            t.preventDefault(),
                                ...
                                null ===
                                    (e = this.button.querySelector('svg')) ||
                                    void 0 === e ||
                                    e.classList.toggle(
                                        'cac__button__menuicon--enabled'
                                    )
                        ...
                        render() {
                            if (
                                ...
                                this.menuContainer = (0, o.createElement)(
                                    'div',
                                    this.parent,
                                    {
                                        className:
                                ...
                                for (let t of this.menuOptions)
                                    this._addMenuOption(t)
                            }
                        }
                        get values() {
                            return this.reset
            ...
            389: (t, e, n) => {
                ...
                n(406),
                    (e.default = class {
                        ...
                        render() {
                            ;(this.iconElement = (0, o.createElement)(
                                'button',
                                this.parent,
                                {
                                ...
                                (this.hoverName = (0, o.createElement)(
                                    'p',
                                    this.iconElement,
                                    {
                                        className:
                                            'cac__tabbar__button__hovername',
                                        innerHTML: this.name,
                                    }
                                ))
                        }
            ...
            67: (t, e, n) => {
                ...
                e.default = class {
                    ...
                    render() {
                        ;(this.notification = (0, o.createElement)(
                            'div',
                            this.parent,
                            {
                ...
                n(789),
                    (e.Section = class {
                        ...
                        _createSectionElements(t) {
                            ;(this.navButton = (0, i.createElement)(
                                'div',
                                this._container,
                                {
                                ...
                                (this.sectionContent = (0, i.createElement)(
                                    'div',
                                    t,
                                    {
                ...
                this && this.__importStar,
                    ...
                    (e.functions = {
                        ...
                        gameretrobowl: function (t, e) {
                            t &&
                                o(
                                    'https://penguinify-web-dev.github.io/retro-bowl/retro.html'
                                )
                        },
                        mouseTrail: function (t, e) {
                            if (t) {
                                ...
                                const t =
                                    document.getElementById('cac__mouseTrail')
                                t && t.remove()
                            }
                        },
                        ...
                        bloons1: function (t, e) {
                            t &&
                                o('https://penguinify-web-dev.github.io/bloons')
                        },
                        bloons2: function (t, e) {
                            t &&
                                o(
                                    'https://penguinify-web-dev.github.io/bloons1'
                                )
                        },
                        agario: function (t, e) {
                            t &&
                        ...
                        slope: function (t, e) {
                            t &&
                                o(
                                    'https://penguinify-web-dev.github.io/slope/index.html'
                                )
                        },
                        rom: function (t, e) {
                            t &&
                        ...
                        yohoho: function (t, e) {
                            t &&
                                o(
                                    'https://penguinify-web-dev.github.io/yohoho/index.html'
                                )
                        },
                        uhoh: function (t, e) {
                            !(function t(e) {
                    ...
                    (function (t) {
                        ...
                        for (let n of i) {
                            ...
                            if (null == i) {
                                o.DEBUG &&
                                    console.log(
                                        `[UI] Section ${n.section} not found!`
                                    )
                                continue
                            }
                            const a =
                                e.functions[n.function] || e.functions.none
                            ;(n.always = n.always || !1),
                                (n.reset = n.reset || !1),
                                (n.options = n.options || {}),
                                i.addButton(
                        ...
                        localStorage.getItem('car-axle-client') &&
                            (function (t) {
                                JSON.parse(
                                    ...
                                    var n
                                    null ===
                                        (n = t.getSectionFromID(e.sectionID)) ||
                                        void 0 === n ||
                                        n.setAllButtonValuesFromArray(
                                            e.buttonValues
                                        )
                                })
                            })(t)
