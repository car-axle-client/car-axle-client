...
export function new_iframe(UI:UIManager, section: HTMLElement, link: string, id: string = ""): HTMLIFrameElement {   
    ...
    let iframe_controls_container = create_element(
        "div",
        section,
        {
    ...
    let iframe_expand = create_element(
        "button",
        iframe_controls_container,
        {
            "class_name": "cac__iframe__svg",
    ...
    iframe_fullscreen.onmousedown = (e) => {iframe.requestFullscreen()}
