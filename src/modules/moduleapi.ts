...
export function new_iframe(
    ...
    try {
        ...
        alert(
            'This website blocks car axle client from loading in an iframe. Please contact the website owner and ask them to allow car axle client to load in an iframe.'
        )
    }
