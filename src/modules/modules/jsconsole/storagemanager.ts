...
function render(UI: UIManager) {
    ...
    let storage_header_selectedbackground = create_element(
        'div',
        storage_header,
        {
    ...
    let storage_header_sessionbutton = create_element(
        'button',
        storage_header,
        {
            class_name: 'cac__storage__header__button',
    ...
    let tab_buttons = [
        storage_header_cookiebutton,
        storage_header_localbutton,
        storage_header_sessionbutton,
    ]
    ...
    tab_buttons.forEach((button) => {
        button.addEventListener('click', () => {
            ...
            storage_header_selectedbackground.style.left =
                button.offsetLeft +
                button.offsetWidth / 2 -
                storage_header_selectedbackground.offsetWidth / 2 +
                'px'
            storage_header_selectedbackground.style.top =
                button.offsetTop - 5 + 'px'
        })
    })
