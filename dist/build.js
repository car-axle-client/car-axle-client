;(() => {
    var __webpack_modules__ = {
                ...
                u.keys().forEach((e) => (d[e] = u(e))),
                    (function () {
                        ...
                        d && e.addModulesFromImport(d),
                            ...
                            console.log(`car axle client - v${s.VERSION}.${s.ITERATION}`)
                    })()
            },
            110: (e, t, n) => {
                'use strict'
            ...
            4997: (e, t, n) => {
                ...
                const a = {
                    ...
                    render: function (e) {
                        ...
                        if (!n) return
                        if (!t) return
                        const a = (0, o.create_element)('div', n, { class_name: 'cac__suggestions__container' }),
                            s =
                                ((0, o.create_element)('h1', a, { innerHTML: 'Suggestions/Bug Reports', class_name: 'cac__suggestions__title' }),
                                (0, o.create_element)('input', a, { value: 'Title', class_name: 'cac__suggestions__input' })),
                            r = (0, o.create_element)('input', a, { value: 'Your Discord/Email', class_name: 'cac__suggestions__input' }),
                            c = (0, o.create_element)('textarea', a, { value: 'Body, describe your suggestion/bug report here', class_name: 'cac__suggestions__input' }),
                            l = (0, o.create_element)('button', a, { innerHTML: 'Submit', class_name: 'cac__suggestions__submit' })
            ...
            4104: (e, t, n) => {
                ...
                Object.defineProperty(t, '__esModule', { value: !0 })
                const o = n(6996)
                var i = { wild: ['No link'], normal: ['No link'] }
                ...
                const a = [
                        ...
                        onactive: () =>
                            (function () {
                                let e = document.getElementById('cac__pocketbrowser__iframe'),
                                    t = i.wild[Math.floor(Math.random() * i.wild.length)]
                                e.src =
                                    'https://' +
                                    (function (e) {
                    ...
                    },
                    {
                        ...
                        onactive: () =>
                            (function () {
                                let e = document.getElementById('cac__pocketbrowser__iframe'),
                                    t = i.normal[Math.floor(Math.random() * i.normal.length)]
                                e.src = 'https://' + atob(t)
                            })(),
                    },
                ]
            ...
            7159: (e, t) => {
                ...
                const n = {
                    ...
                    display_name: (function () {
                        console.log('yh')
                        try {
                            return fetch('https://www.google.com'), !0
                        } catch {
                            return !1
                        }
                        return !1
                        ...
                        : 'Script Status: Offline (Try another website)',
