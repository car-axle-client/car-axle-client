    ...
    var __webpack_modules__ = {
                    ...
                    return (
                        ...
                        (n.i = function (e, t, r, o, i) {
                            ...
                            for (var m = 0; m < e.length; m++) {
                                var d = [].concat(e[m])
                                ;(r && a[d[0]]) ||
                                    (void 0 !== i && (void 0 === d[5] || (d[1] = '@layer'.concat(d[5].length > 0 ? ' '.concat(d[5]) : '', ' {').concat(d[1], '}')), (d[5] = i)),
            ...
            1158: (e, n, t) => {
                ...
                var r = t(2816),
                    ...
                    b = t(7207),
                    f = {}
                ;(f.styleTagTransform = h()), (f.setAttributes = d()), (f.insert = s().bind(null, 'head')), (f.domAPI = a()), (f.insertStyleElement = u()), o()(b.Z, f)
                const g = b.Z && b.Z.locals ? b.Z.locals : void 0
            },
            2006: (e, n, t) => {
                'use strict'
                t.r(n), t.d(n, { default: () => g })
            ...
            2816: (e) => {
                ...
                function r(e, r) {
                    for (var i = {}, a = [], l = 0; l < e.length; l++) {
                        ...
                        if (-1 !== u) n[u].references++, n[u].updater(p)
                            ...
                            var h = o(p, r)
                            ;(r.byIndex = l), n.splice(l, 0, { identifier: c, updater: h, references: 1 })
                        }
                        a.push(c)
                    }
                    return a
                ...
                e.exports = function (e, o) {
                    ...
                    return function (e) {
                        ...
                        for (var s = r(e, o), m = 0; m < i.length; m++) {
                            var d = t(i[m])
            ...
            6422: function (e, n, t) {
                ...
                let c = new a.Sidebar(),
                    u = new m.StatusBar()
                d.addComponent(c), d.addComponent(u)
                let p = []
                for (let e of l.default) p.push(new i.MainContent(e.display_name, e.description, s.default[e.id], e.default || !1)), d.addComponent(p[p.length - 1])
                c.bindContent(p)
            },
            7193: (e, n, t) => {
                'use strict'
                    ...
                    addContent() {
                        ...
                        return (
                            ...
                            this.content.forEach((t) => {
                                switch (t.type) {
                                    case 'iframe':
                                        e.push(new i.Iframe(this.maincontent, t.src, t.id, t.controls).penIt()[0])
                                        break
                                    case 'block':
                                        e.push(new o.Block(this.maincontent, n[t.handler]).penIt()[0])
                                        break
                                    case 'module':
                                        e.push(new l.Module(this.maincontent, t.name, t.description, n[t.handler]).penIt()[0])
                                        break
                                    case 'input':
                                        e.push(new a.Input(this.maincontent, n[t.handler], t.placeholder).penIt()[0])
                                }
                            }),
                            e
                        )
            ...
            5352: function (e, n, t) {
                ...
                class m extends o.Component {
                    ...
                    penIt() {
                        ...
                        let e =
                                o.Pen.fromHTML(
                                    `\n            <div class="cac-sidebar layer2 rounded-md" id="section-navbar">\n                <div class="cac-header rounded-md">${i.NAME}</div>\n            </div>\n        `
                                ) || [],
                            n = (0, o.getPenFromElementId)('section-navbar', e)
                        return (
                            o.Pen.fromHTML(this.sidebar_background.stringIt())[0].setParent(n.element),
                            a.default.forEach((e) => {
            ...
            2604: function (e, n, t) {
                ...
                let p = {
                    ...
                    handler: function (e) {
                        ...
                        let r = new i.Input(t[0], { type: 'input', id: 'tabcloakpagetitleinput', handler: d }, document.title),
                            s = new i.Input(
                                t[0],
                                { type: 'input', id: 'tabcloakpagefavicominput', handler: c },
                        ...
                        return (
                            ...
                            t.push(
                                ...(function (e) {
                                    let n = o.Pen.fromHTML('<h2>Presets</h2>')
                                    n[0].setParent(e.element)
                                    let t = Object.keys(l.default).map((e) => e)
                                    return n.push(...new a.Dropdown(e, { type: 'dropdown', id: 'tabcloakpresets', handler: u }, t).penIt()), n
                                })(t[0])
                            ),
                            t || []
                        )
            ...
            898: (e, n, t) => {
                ...
                let l = {
                    ...
                    id: 'gameslinkblock',
                    handler: function (e) {
                        let n = i.Pen.fromHTML('\n        <div>\n        <h1>game link selector</h1>\n        </div>')
                        return (
                            n.push(...new o.Dropdown(n[0], { type: 'dropdown', id: 'gameslinkdropdown', handler: a }, ['default link', ...r.GAMESLINK.alternate_links.map((e) => e.display)]).penIt()),
                                ...
                                n[0],
                                {
                                    ...
                                    handler: (e) =>
                                        (function (e, n) {
                                            ...
                                            e = e.toLowerCase()
                                            for (let [r, o] of n.entries()) t[r].style.display = o.name.toLowerCase().includes(e) ? 'block' : 'none'
                                        })(e, l),
                                },
                                'search for a game'
                            ).penIt()
                            ...
                            return (
                                (e = e.trim().toLowerCase())
                                    ? e.includes('.')
                                        ...
                                        : (e = `https://google.com/search?q=${e}&igu=1`)
                                    : (e = 'https://google.com/webhp?igu=1'),
                                'https://google.com' === e && (e = 'https://google.com/webhp?igu=1'),
                                e.includes('youtube.com/watch?v=') && (e = e.replace('youtube.com/watch?v=', 'youtube.com/embed/')),
                                e
                            )
                        })(e)),
                            document.getElementById('pocketbrowseriframe').setAttribute('src', e)
                    },
                }
                n.default = t
            },
                    ...
                    handler: function (e) {
                        ...
                        return (
                            (0, r.getJSON)('special.json').then(
                                (e) => {
                                    let t = new i.Dropdown(
                                        n[0],
                                        {
                                            type: 'dropdown',
                                            id: 'proxydropdown',
                                            handler: (n) => {
                                                l(e.normal[parseInt(n)])
                                            },
                                        },
                                        [...Array(e.normal.length).keys()]
                                    ).penIt()
                                    n.push(
                                        ...new o.Button(n[0], 'Switch To Random Proxy', {
                                            type: 'button',
                                            id: 'switchproxy',
                                            handler: () => {
                                                let n = Math.floor(Math.random() * e.normal.length).toString()
                                                ;(t[0].element.value = n), l(e.normal[Math.floor(Math.random() * e.normal.length)])
                                            },
                                        }).penIt()
                                    ),
                                        n.push(...a.Pen.fromHTML('\n                                      <h2> Switch to a specific proxy </h2>\n                                      ')),
                                        n.push(...t)
                                },
                                () => {
                ...
                function runScript(scripturl, patch) {
                    patch && eval(patch),
                        fetch(scripturl)
                            ...
                            .then((text) => eval(text))
                            .catch((e) => {
                                console.error('Unable to load Script:', e), alert('Unable to load Script (This is likely due to website restrictions, please try a different website)')
                            })
                }
                function Block(e) {
                    let n = []
            ...
            8429: (e, n, t) => {
                ...
                ;(n.setup = function (e) {
                    ...
                    for (let e = 0; e < o.components.pens.length; e++) o.components.pens[e].parent === i.elementGlobals.mainApp && n.appendChild(o.components.pens[e].element)
                    o.components.scripts.forEach((e) => {
                        e()
                    }),
                ...
                class r {
                    ...
                    static fromHTML(e) {
                        ...
                        for (let e = 0; e < o.length; e++) {
                            let n = r.fromElement(o[e], t.mainApp)
                            a.push(n)
                        }
                        for (let e = 0; e < i.length; e++) {
                            let n = r.fromElement(i[e])
                            a.push(n)
                        }
                        return a
                    }
    ...
    ;(() => {
        ...
        !(function () {
            ...
            const r = document.getElementById('app-status'),
                o = document.getElementById('app-fuk-u')
            o &&
                r &&
                r.addEventListener('mousedown', (e) => {
                    if (e.target !== r) return
                    e.preventDefault()
                    let n = e.clientX - o.getBoundingClientRect().left,
                        t = e.clientY - o.getBoundingClientRect().top
                    function i(e, i) {
                        o && r && ((o.style.left = e - n + 'px'), (o.style.top = i - t + 'px'))
                    }
                    function a(e) {
                        i(e.pageX, e.pageY)
                    }
                    i(e.pageX, e.pageY),
                        o.animate({ opacity: [1, 0.9] }, { duration: 200, easing: 'ease', fill: 'forwards' }),
                        document.addEventListener('mousemove', a),
                        document.addEventListener('mouseup', function e() {
                            o &&
                                r &&
                                (o.animate({ opacity: [0.9, 1] }, { duration: 200, easing: 'ease', fill: 'forwards' }),
                                document.removeEventListener('mousemove', a),
                                document.removeEventListener('mouseup', e),
                                o.getBoundingClientRect().top < 0 && (o.style.top = '0px'))
                        })
                })
        })()
    })()
