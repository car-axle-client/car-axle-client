    ...
    var __webpack_modules__ = {
            ...
            1158: (e, n, t) => {
                ...
                var o = t(2816),
                    ...
                    b = t(7207),
                    g = {}
                ;(g.styleTagTransform = p()), (g.setAttributes = d()), (g.insert = s().bind(null, 'head')), (g.domAPI = i()), (g.insertStyleElement = u()), r()(b.Z, g)
                ...
                function o(e, o) {
                    for (var a = {}, i = [], l = 0; l < e.length; l++) {
                        ...
                        if (-1 !== u) n[u].references++, n[u].updater(h)
                            ...
                            var p = r(h, o)
                            ;(o.byIndex = l), n.splice(l, 0, { identifier: c, updater: p, references: 1 })
                        }
                        i.push(c)
                    }
                    return i
            ...
            6422: function (e, n, t) {
                ...
                let h = []
                for (let e of l.default) h.push(new a.MainContent(e.display_name, e.description, s.default[e.id], e.default || !1)), d.addComponent(h[h.length - 1])
                c.bindContent(h)
            },
            7193: (e, n, t) => {
                'use strict'
                        ...
                        return (
                            ...
                            t.push(
                                ...(function (e) {
                                    ...
                                    return n.push(...new i.Dropdown(e, { type: 'dropdown', id: 'tabcloakpresets', handler: h }, t).penIt()), n
                                })(t[0])
                            ),
                            (function () {
            ...
            898: (e, n, t) => {
                ...
                function i(e) {
                    if ('default link' === e) o.GAMESLINK.currentLink = o.GAMESLINK.defaultLink
                        ...
                        let n = o.GAMESLINK.alternate_links.find((n) => n.display === e)
                        n && (o.GAMESLINK.currentLink = n.url)
                    }
                }
                let l = {
                    type: 'block',
                    ...
                    handler: function (e) {
                        ...
                        return (
                            n.push(...new r.Dropdown(n[0], { type: 'dropdown', id: 'gameslinkdropdown', handler: i }, ['default link', ...o.GAMESLINK.alternate_links.map((e) => e.display)]).penIt()),
                                    ...
                                    n.push(
                                        ...new r.Button(n[0], 'Switch To Random Proxy', {
                                            ...
                                            handler: () => {
                                                ...
                                                e.normal[parseInt(n)].startsWith('http')
                                                    ? ((t[0].element.value = n), l(e.normal[Math.floor(Math.random() * e.normal.length)]))
                                                    : alert('Invalid proxy URL, try using car axle client on a different website')
                                            },
                                        }).penIt()
                                    ),
                ...
                n.setup = function (
                    ...
                    if (
                        (document.addEventListener('keydown', (n) => {
                            ...
                            switch (n.key) {
                                case '\\':
                                    null === (t = document.getElementById(e)) || void 0 === t || t.style.display
                                    break
                                case 'F2':
