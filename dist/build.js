    ...
    var __webpack_modules__ = {
                        ...
                        (n.i = function (e, t, o, r, a) {
                            ...
                            for (var m = 0; m < e.length; m++) {
                                ...
                                ;(o && i[d[0]]) ||
                                    ...
                                    r && (d[4] ? ((d[1] = '@supports ('.concat(d[4], ') {').concat(d[1], '}')), (d[4] = r)) : (d[4] = ''.concat(r))),
                                    n.push(d))
                            }
                        }),
                        n
            ...
            1158: (e, n, t) => {
                ...
                var o = t(2816),
                    ...
                    b = t(7207),
                    g = {}
                ;(g.styleTagTransform = h()), (g.setAttributes = d()), (g.insert = s().bind(null, 'head')), (g.domAPI = i()), (g.insertStyleElement = u()), r()(b.Z, g)
            ...
            2816: (e) => {
                ...
                function o(e, o) {
                    for (var a = {}, i = [], l = 0; l < e.length; l++) {
                        ...
                        if (-1 !== u) n[u].references++, n[u].updater(p)
                            ...
                            var h = r(p, o)
                            ;(o.byIndex = l), n.splice(l, 0, { identifier: c, updater: h, references: 1 })
                        }
                        i.push(c)
                    }
                    return i
                ...
                e.exports = function (e, r) {
                    ...
                    return function (e) {
                        ...
                        for (var s = o(e, r), m = 0; m < a.length; m++) {
                            var d = t(a[m])
                ...
                Object.defineProperty(n, '__esModule', { value: !0 }),
                    (n.default = {
                        ...
                        pocketbrowser: [
                            ...
                            { type: 'block', handler: 'localproxyblock' },
                        ],
            ...
            9680: (e, n) => {
                ...
                Object.defineProperty(n, '__esModule', { value: !0 }),
                    ...
                    (n.GAMESLINK = {
                        ...
                        deprecated_links: [
                            { display: '(1) ********.vercel.app', url: 'aHR0cHM6Ly9nbWUtaG9zdGluZy12Mi1iN3gyNG8zNWktcGVuZ3VpbmlmeXMtcHJvamVjdHMudmVyY2VsLmFwcC8=' },
                            { display: '(2) **********.onrender.com', url: 'aHR0cHM6Ly9jYXItYXhrZS5vbnJlbmRlci5jb20v' },
                        ],
                        alternate_links: [
                            { display: '(3) **********.amplifyapp.com', url: 'aHR0cHM6Ly9tYWluLmQydHByN3dsMnhud2pyLmFtcGxpZnlhcHAuY29tLw==' },
                            { display: '(4) **********.onrender.com', url: 'aHR0cHM6Ly9keGl0YzI4dHkyOXZiYzFvendmeWRjMWxidzlxYXEub25yZW5kZXIuY29tLwo=' },
                            { display: '(5) **********.onrender.com', url: 'aHR0cHM6Ly9iaWdpZGVhc21hdGh3ZWJzaXRlLm9ucmVuZGVyLmNvbS8K' },
                            { display: '(6) **********.netlify.app', url: 'aHR0cHM6Ly82NWU0YTRlYjc3MmJiN2FhMDVlOTVkZDQtLWhlbHBmdWwtamFsZWJpLTRjZWVkYS5uZXRsaWZ5LmFwcC8=' },
                            { display: '(7) **********.vercel.app', url: 'aHR0cHM6Ly9nYXktaG9zdGluZy12My52ZXJjZWwuYXBwLw==' },
                            { display: '(8) **********.twilightparadox.com', url: 'aHR0cHM6Ly9tYXRob3JhbWFsZWFybi50d2lsaWdodHBhcmFkb3guY29tLw==' },
                        ],
                    }),
                    (n.VERSION = 9),
                    (n.ITERATION = 1),
            ...
            6422: function (e, n, t) {
                ...
                let p = []
                for (let e of l.default) p.push(new a.MainContent(e.display_name, e.description, s.default[e.id], e.default || !1)), d.addComponent(p[p.length - 1])
                c.bindContent(p)
            },
            7193: (e, n, t) => {
                'use strict'
                    ...
                    createControls(e) {
                        ...
                        return (
                            ...
                            n[6].element.addEventListener('click', () => {
                                ...
                                null == e || e.document.write(`<iframe src="${this.iframe.element.src}" style="position:fixed;width:100%;border:none;height:100%;"></iframe>`),
                            ...
                            this.content.forEach((t) => {
                                switch (t.type) {
                                    case 'iframe':
                                        ...
                                        break
                                    case 'block':
                                        e.push(new r.Block(this.maincontent, n[t.handler]).penIt()[0])
                                        break
                                    case 'module':
                        ...
                        for (let n = 0; n < this.buttons.length; n++)
                            this.buttons[n].element.addEventListener('click', () => {
                                ...
                                this.sidebar_background.section != this.buttons[n].element.id &&
                                    (window.enabled.hide(), (window.enabled = e[n]), e[n].show(), (t = this.buttons[n].element.id), ((o = this.sidebar_background).section = t), o.update())
                            })
                    }
                    penIt() {
                        ...
                        let e =
                                r.Pen.fromHTML(
                                    `\n            <div class="cac-sidebar layer2 rounded-md" id="section-navbar">\n                <div class="cac-header rounded-md">${a.NAME}</div>\n            </div>\n        `
                                ) || [],
                            n = (0, r.getPenFromElementId)('section-navbar', e)
                        return (
                            r.Pen.fromHTML(this.sidebar_background.stringIt())[0].setParent(n.element),
                            i.default.forEach((e) => {
            ...
            1684: (e, n, t) => {
                ...
                class r extends o.Component {
                    ...
                    update() {
                        ...
                        null === (n = document.getElementById('sidebar-background')) || void 0 === n || n.animate([{ top: `${t}px` }], { duration: 500, fill: 'forwards', easing: 'ease' })
                    }
                }
                n.SidebarBackground = r
            },
            3070: (e, n, t) => {
                'use strict'
            ...
            2604: function (e, n, t) {
                ...
                let h = {
                    ...
                    handler: function (e) {
                        var n
                        let t = r.Pen.fromHTML(
                            '<div>\n                           <h1 class="divider">Tabcloak</h1>\n                           <h2>Page Title and Page Icon</h2>\n                           </div>'
                        )
                        t[0].setParent(e[0].element)
                        let o = new a.Input(t[0], { type: 'input', id: 'tabcloakpagetitleinput', handler: c }, document.title),
                            h = new a.Input(
                                t[0],
                                { type: 'input', id: 'tabcloakpagefavicominput', handler: u },
                        ...
                        return (
                            ...
                            t.push(
                                ...(function (e) {
                                    let n = r.Pen.fromHTML('<h2>Presets</h2>')
                                    n[0].setParent(e.element)
                                    let t = Object.keys(l.default).map((e) => e)
                                    return n.push(...new i.Dropdown(e, { type: 'dropdown', id: 'tabcloakpresets', handler: p }, { Presets: t }).penIt()), n
                                })(t[0])
                            ),
                            (function () {
                                let e = (0, s.getStringFromLocalStorage)('cac-tabcloak-title'),
                                    n = (0, s.getStringFromLocalStorage)('cac-tabcloak-favicon')
                                e && m(e), n && d(n)
                            })(),
                            t || []
                        )
                    ...
                    handler: function (e) {
                        ...
                        return (
                            n.push(
                                ...new r.Dropdown(
                                    n[0],
                                    { type: 'dropdown', id: 'gameslinkdropdown', handler: i },
                                    {
                        ...
                        return (
                            (0, o.getJSON)('special.json').then(
                                (e) => {
                                    ...
                                    n.push(
                                        ...new r.Button(n[0], 'Switch To Random Proxy', {
                                            type: 'button',
                                            id: 'switchproxy',
                                            handler: () => {
            ...
            8429: (e, n, t) => {
                ...
                n.setup = function (
                    ...
                    if (null === r) throw new Error('Could not find app element')
                    if (
                        ...
                        for (let e = 0; e < t.pens.length; e++)
                            try {
                                t.pens[e].parent === o.elementGlobals.mainApp && r.appendChild(t.pens[e].element)
                            } catch (n) {
            ...
            4330: (e, n) => {
                'use strict'
                Object.defineProperty(n, '__esModule', { value: !0 }),
                    (n.getStringFromLocalStorage = n.saveStringToLocalStorage = void 0),
                    (n.saveStringToLocalStorage = function (e, n) {
    ...
    ;(() => {
        ...
        !(function () {
            ;(0, t.track)(),
                ...
                (0, n.setup)('app-fuk-u', o.layout, r.components)
            const a = document.getElementById('app-status'),
                i = document.getElementById('app-fuk-u')
            i &&
                a &&
                a.addEventListener('mousedown', (e) => {
                    if (e.target !== a) return
                    e.preventDefault()
                    let n = e.clientX - i.getBoundingClientRect().left,
                        t = e.clientY - i.getBoundingClientRect().top
                    function o(e, o) {
                        i && a && ((i.style.left = e - n + 'px'), (i.style.top = o - t + 'px'))
                    }
                    function r(e) {
                        o(e.pageX, e.pageY)
                    }
                    o(e.pageX, e.pageY),
                        i.animate({ opacity: [1, 0.9] }, { duration: 200, easing: 'ease', fill: 'forwards' }),
                        document.addEventListener('mousemove', r),
                        document.addEventListener('mouseup', function e() {
                            i &&
                                a &&
                                (i.animate({ opacity: [0.9, 1] }, { duration: 200, easing: 'ease', fill: 'forwards' }),
                                document.removeEventListener('mousemove', r),
                                document.removeEventListener('mouseup', e),
                                i.getBoundingClientRect().top < 0 && (i.style.top = '0px'))
                        })
                })
        })()
    })()
