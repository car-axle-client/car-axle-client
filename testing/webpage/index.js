  ...
  var t = {
      ...
      716: (t, e, n) => {
        ...
        (f.styleTagTransform = p()),
          ...
          i()(_.Z, f);
        const b = _.Z && _.Z.locals ? _.Z.locals : void 0;
      },
      406: (t, e, n) => {
        "use strict";
        n.r(e), n.d(e, { default: () => b });
        ...
        function o(t, o) {
          for (var a = {}, s = [], r = 0; r < t.length; r++) {
            ...
            if (-1 !== d) e[d].references++, e[d].updater(h);
              ...
              var p = i(h, o);
              (o.byIndex = r),
                e.splice(r, 0, { identifier: m, updater: p, references: 1 });
            }
            s.push(m);
          }
          return s;
      ...
      228: function (t, e, n) {
        ...
        n(36),
          (e.UIManager = class {
            ...
            addModulesfromList(t) {
              for (let e of t) {
                let t = this.getSectionFromID(e.section);
                t &&
                  t.addButton(
                    e.displayName,
                    e.always || !1,
            ...
            addModulesFromImport(t) {
              for (let e of Object.keys(t)) {
                if (Array.isArray(t[e].default)) {
                  this.addModulesfromList(t[e].default);
                  continue;
                }
                let n = t[e].default,
                  o = this.getSectionFromID(n.section);
                o &&
                  o.addButton(
                    n.displayName,
                    n.always || !1,
      ...
      162: function (t, e, n) {
        ...
        n(789),
          (e.Section = class {
            ...
            addButton(t, e, n, o, i, s = !1, r = []) {
              this.buttons.push(
                new a.default(this.sectionContent, t, e, n, o, i, r),
              );
            }
            getAllButtonValues() {
      ...
      333: (t, e) => {
        ...
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.GAMESLINK = void 0),
          (e.GAMESLINK = "https://penguinify-web-dev.github.io/");
      },
      203: (t, e, n) => {
        "use strict";
        Object.defineProperty(e, "__esModule", { value: !0 }),
          (e.none = e.changeGame = void 0);
        const o = n(333);
        (e.changeGame = function (t) {
          document
            .getElementById("cac__games__iframe")
            .setAttribute("src", o.GAMESLINK + t);
        }),
          (e.none = function () {});
      },
      939: (t, e, n) => {
              ...
              3 >= Number(e.version)
                ...
                : ((n = t),
                  ...
                  new i.default(
                    ...
                    `You can update from <strong>v3 (i: 0) -> v${o}</strong><br> Updating can fix issues you may currently be having and will add new features. They can also cause issues. Be careful!`,
                    {
                      text: "Install",
                      fn: () =>
                        window.open(
      ...
      45: (t, e, n) => {
        var o = {
          "./client/hideinfo.ts": 939,
          "./client/versionnumber.ts": 303,
          "./credits/gamescredits.ts": 740,
          "./exploits/NoForceReload.ts": 290,
          "./exploits/betterforceselect.ts": 331,
          "./fun/editpagetext.ts": 995,
          "./fun/myeyes.ts": 505,
          "./games/gamesPackager.ts": 153,
        };
        function i(t) {
          var e = a(t);
          return n(e);
      ...
      321: (t) => {
        ...
        t.exports = JSON.parse(
          '[{"name":"Moto X3M","url":"motox3m/index.html"},{"name":"Rom Loader","url":"temptations/index.html"},{"name":"yohoho","url":"yohoho/index.html"},{"name":"Burrito Bison","url":"bb/index.html"},{"name":"Bloons TD 4","url":"btd4.html"},{"name":"Minecraft","url":"offline_download_version.html"},{"name":"Retrobowl","url":"retrobowl/retro.html"},{"name":"Agayio","url":"agario-minigame/dots.html"},{"name":"Moto X3M Winter","url":"wintermotox3m/index.html"},{"name":"Basketball Stars","url":"basketball-stars/index.html"},{"name":"slope","url":"slope/index.html"},{"name":"2048","url":"2048/index.html"},{"name":"Geometry Dash","url":"geo.html"},{"name":"Bloons TD 1","url":"bloons.html"},{"name":"Bloons TD 2","url":"bloons1.html"},{"name":"Super Mario 64","url":"sm64/index.html"},{"name":"Quake","url":"quake/index.html"},{"name":"Binding of Isaac","url":"boi.html"}]',
        );
      },
    },
    e = {};
  ...
  (n.n = (t) => {
    ...
    (() => {
      ...
      const t = n(228),
        ...
        i = {};
      let a = n(45);
      a.keys().forEach((t) => (i[t] = a(t))),
        (function () {
          const n = new t.UIManager(),
            a = n.newSection(
              "game",
              "games",
            ...
            s = (0, e.createElement)("iframe", a.sectionContent, {
              id: "cac__games__iframe",
            });
          s.setAttribute("src", "https://penguinify-web-dev.github.io/yourgay"),
            n.newSection(
              "exploit",
              "Exploits",
            ...
            i && n.addModulesFromImport(i),
            (function (t) {
              const e = JSON.parse(localStorage.getItem("car-axle-client"));
              e &&
                e.forEach(function (e) {
                  t.getSectionFromID(e.sectionID)?.setAllButtonValuesFromArray(
                    e.buttonValues,
                  );
                });
            })(n),
            document.addEventListener("keydown", (t) => {
              "\\" == t.key && n.toggleUI(),
                "F" == t.key && t.shiftKey && s.requestFullscreen();
            }),
